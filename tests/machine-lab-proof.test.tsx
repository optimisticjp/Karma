...
describe("studio and technique proof", () => {
  it("gives every currently public technique its own mark on /about", () => {
    /* The source catalogue still carries eleven techniques, while the public
       wall follows Console visibility so a hidden course cannot reappear as
       proof on /about. */
