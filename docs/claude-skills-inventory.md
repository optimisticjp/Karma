> **Imported verbatim from the skill library, not written for Karma.**
>
> This is `INSTALL_REPORT.md` from
> [`optimisticjp/claude-web-builder-skills`](https://github.com/optimisticjp/claude-web-builder-skills)
> at commit `ceb9b0a449f619f37542c0f1acc1c94f986e7b6d`, copied on 2026-08-30 as
> the per-skill inventory behind `.claude/skills/`. It describes the *source*
> repository — its Next.js 16 starter, its `components.json`, its shadcn
> initialisation and its generic constitution. **None of that came into Karma;
> only the skills did.**
>
> For what Karma actually imported, how to use it and what to ignore, read
> [`docs/claude-skills.md`](./claude-skills.md). Where this file and that one
> disagree about Karma, that one is right.
