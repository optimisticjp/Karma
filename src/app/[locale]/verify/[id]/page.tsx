  ...
  return (
    <section className="section-compact">
      <div className="container-site max-w-2xl">
        ...
        {!dbConfigured ? (
          <div className="card mt-8 border-marigold p-6">
          ...
          <div className="card mt-8 border-success p-6">
          ...
          <div className="card mt-8 border-error p-6">
            <p className="text-h3 font-display text-error">{t("invalidTitle")}</p>
            <p className="mt-2 font-mono text-smallmeta text-stone">{certNo}</p>
            <p className="mt-3 text-stone">{t("invalidBody")}</p>
          </div>
        )}
