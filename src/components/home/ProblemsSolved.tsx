 ...
 * five things that actually go wrong on a production floor — which is exactly
 ...
 *
 * Set as fault → cause pairs rather than cards. A card grid would flatten
 * five specific, unequal problems into five equal boxes.
 */
