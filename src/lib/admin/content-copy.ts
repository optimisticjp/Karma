...
const COPY = {
  en: {
    ...
    edit: "Edit",
    archive: "Archive",
    mediaUrl: "Photo path / HTTPS URL",
    mediaHelp: "Student-work photos need a real image before Publish. Use a site path such as /photos/work/example.webp or an HTTPS image URL. Upload tooling will move to Cloudflare later.",
    english: "English",
    ...
    errors: {
      ...
      media: "Student work needs a real photo path or HTTPS image URL before it can be published.",
  ...
  gu: {
    ...
    archive: "Archive",
    mediaUrl: "Photo path / HTTPS URL",
    mediaHelp: "Student work Publish કરવા real image જરૂરી છે. /photos/work/example.webp જેવી site path અથવા HTTPS image URL નાખો. Upload tooling પછી Cloudflare પર જશે.",
    english: "English",
    ...
    errors: {
      ...
      media: "Student work Publish કરવા real photo path અથવા HTTPS image URL જરૂરી છે.",
